...
describe('useConflictsTable', () => {
  ...
  describe('Loading and Display', () => {
    it('should load initial data and correctly parse conflicts and roles', async () => {
      ...
      await driver.expectGoogleSheetsApiCall(
        'load',
        `${ROLES_CONFLICT_SHEET_ID}!A1:Z1000`
      );
    });
    ...
    it('should show loading state during data fetch', async () => {
      ...
      void driver.setTestData(apiResult.promise, false); // Don't wait for load
